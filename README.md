...
- **Metrics**:
  - Low MAE/RMSE, high R-squared (**Exact**: MAE = 2.298e-11, R² = 1.0) indicate precise predictions, implying high confidence.
  - High MAE/RMSE, negative R-squared (**Random**: MAE = 25.1148, R² = -0.0054) indicate poor predictions, implying low confidence.
